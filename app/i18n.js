const I18N_DICT = {
  ...
  ja: {
    ...
    budget_label: '予算', discount: '割引', disc_all: 'すべての割引', disc_50: '50%以上オフ', disc_70: '70%以上オフ', disc_90: '90%以上オフ',
    genre_label: 'ジャンル', genre_all: 'すべて', sort_label: '並び替え',
    sort_disc: '割引が大きい順', sort_pasc: '価格が安い順', sort_pdesc: '価格が高い順', sort_name: '名前 A–Z', sort_rev: '高評価順',
    stat_total: 'セール中', stat_max: '最大割引', stat_avg: '平均割引', stat_free: '無料ゲーム',
    budget_q: 'この予算で何が買える？', budget_ph: '予算を入力 例: 500', budget_find: '探す',
    tab_sale: 'セール', tab_free: '無料', tab_dlc: 'DLC', tab_wish: 'ウィッシュリスト',
    title_sale: '現在のセール', title_free: '現在の無料', title_dlc: 'DLCセール', title_wish: 'あなたのウィッシュリスト',
    loading: '読み込み中...', empty: '条件に合うゲームがありません', cant_connect: '接続できません — 更新してください', items: '件',
    wish_add: 'ウィッシュリストに追加', wish_remove: 'ウィッシュリストから削除',
    enter_budget: 'まず予算を入力してください', buy_count: 'この予算で{n}件購入可能',
    budget_none: '{b}以内に商品なし', budget_head: '予算{b}で{n}件購入可能 · おすすめ:', budget_tot: '合計 {t} · 残り {r}',
    budget_showing: '{b}以内のゲームを表示',
    ago_s: '{n}秒前', ago_m: '{n}分前', ago_h: '{n}時間前', updated: '更新 {t}',
  ...
  es: {
    ...
    budget_label: 'Presupuesto', discount: 'Descuento', disc_all: 'Todos los descuentos', disc_50: '50%+ off', disc_70: '70%+ off', disc_90: '90%+ off',
    genre_label: 'Género', genre_all: 'Todos', sort_label: 'Ordenar por',
    sort_disc: 'Mayor descuento', sort_pasc: 'Precio más bajo', sort_pdesc: 'Precio más alto', sort_name: 'Nombre A–Z', sort_rev: 'Mejores reseñas',
    stat_total: 'En oferta', stat_max: 'Descuento máx.', stat_avg: 'Descuento medio', stat_free: 'Juegos gratis',
    budget_q: '¿Qué puedo comprar con este presupuesto?', budget_ph: 'Ingresa presupuesto ej. 500', budget_find: 'Buscar',
    tab_sale: 'En oferta', tab_free: 'Gratis', tab_dlc: 'DLC', tab_wish: 'Lista de deseos',
    title_sale: 'Ofertas ahora', title_free: 'Gratis ahora', title_dlc: 'DLC en oferta', title_wish: 'Tu lista de deseos',
    loading: 'Cargando...', empty: 'Ningún juego coincide', cant_connect: 'Sin conexión — actualiza', items: 'artículos',
    wish_add: 'Añadido a la lista de deseos', wish_remove: 'Eliminado de la lista de deseos',
    enter_budget: 'Ingresa un presupuesto primero', buy_count: 'Puedes comprar {n} con este presupuesto',
    budget_none: 'Sin artículos dentro de {b}', budget_head: 'Presupuesto {b} compra {n} artículos · sugerido:', budget_tot: 'Total {t} · resto {r}',
    budget_showing: 'Mostrando juegos dentro de {b}',
    ago_s: 'hace {n}s', ago_m: 'hace {n}m', ago_h: 'hace {n}h', updated: 'Actualizado {t}',
